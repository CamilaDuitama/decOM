...
def main():
    ...
    # Parser
    parser = argparse.ArgumentParser(prog="decOM-MST",
    ...
    if checked_input == 1:
        ...
        sink, p_sinks, p_sources, m, key, p_keys, t, plot, output, mem = checked_input

    print_status("Starting decOM-MST version: " + str(_version()))
    print_status("MST feature of decOM has started")

    print_status("Arguments decOM-MST:"+"\n"+ 
    "sink: "+str(sink)+","+
    "p_sinks: "+str(p_sinks)+","+
